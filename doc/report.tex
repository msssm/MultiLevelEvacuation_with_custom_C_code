...
%TODO: finalize (write out every etc.) Hans compare with RESEARCH!
...
%  'linear'
% optimierungsversuch mit parfor (in den einzelnen kräften): nicht schneller, da
% viel daten ausgetauscht werden müssen
