...
%TODO: WHATTHEFUCK is the point of this sentence?? there exists a wall force NORMAL to the wall SUCH THAT the closer agents gets to walls the stronger gets the TANGENTIAL force. please guys, could you at least read ONCE what you write?!?
...
This is off course not a very realistic behavior but due to the simplicity of our agents demand to reach the
...
As there were already other project in this course which studied agent based evacuation simulations, 
...
Alexander Jöhl and Tom\'{a}\v{s} Nyitray \cite{oldproj}.
