...
fastest way out of a building. We knew that matlab code is not very fast and
matlab provides an interface for other programming languages. So we used C to
...
introduced a Range Tree for this problem, which he also implemented in C.
...
Since matlab is not really object-oriented, we used a big data structure (called
